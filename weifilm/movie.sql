...
--
-- Table structure for table `('none_table',)`
--

DROP TABLE IF EXISTS `('none_table',)`;
...
--
-- Dumping data for table `('none_table',)`
--

LOCK TABLES `('none_table',)` WRITE;
/*!40000 ALTER TABLE `('none_table',)` DISABLE KEYS */;
/*!40000 ALTER TABLE `('none_table',)` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `admin` VALUES (1,'stf','pbkdf2:sha256:260000$sROflr8DV1uQ0Ifz$880391e3931bc135d93323e4dd44855b6cd3bc9e35760c4ad34f70f8c4244b84',0,1,'2022-05-09 22:33:28');
...
INSERT INTO `preview` VALUES (1,'乐侃有声节目第二期','20220509223705bbc5edd9d5dc41678939be6de641c8ad.jpg','2022-05-09 22:37:06'),(2,'周杰伦粉丝版MV','20220509223721f36a9328a5f84c52a0b536f5f9d89bc4.jpg','2022-05-09 22:37:21'),(3,'乐见大牌：”荣“耀之声，”维“我独尊','20220509223741eef9d588b09b4506acd4b04e427d5b24.jpg','2022-05-09 22:37:42'),(4,'王力宏四年心血结晶','2022050922380783959329d8fb4c75b3ee04407f9a9487.jpg','2022-05-09 22:38:07'),(5,'MV精选：《武媚》女神团美艳大比拼','2022050922382305d52956ac5a4812a71b05f33fa384b6.jpg','2022-05-09 22:38:24');
...
INSERT INTO `role` VALUES (1,'超级管理员','','2022-05-09 22:33:28');
...
-- Dump completed on 2022-05-09 22:39:34
